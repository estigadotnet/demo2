...
$CONFIG = [
	...
	"RANDOM_KEY" => 'etIDyTaIGFwcWBcA', // Random key for encryption
	...
	"PROJECT_ID" => "{1AAD1A73-56B4-43BC-A714-7268915FE311}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => 3307, "user" => "root", "pass" => "admin", "db" => "db_ga"]
	],
