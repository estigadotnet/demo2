...
class input2
{
	...
	// Table name
	public $TableName = 'input2.php';

	// Page object name
	public $PageObjName = "input2";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'input2.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "input2", $url, "", "input2", TRUE);
		$this->Heading = $Language->TablePhrase("input2", "TblCaption"); 
	}
} // End class
?>