 ...
 * Page class
 */
class t_distribusi_delete extends t_distribusi
{
	...
	// Page object name
	public $PageObjName = "t_distribusi_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_distribusilist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_distribusilist.php"); // Return to list
			}
		}
	}
