...
class input4
{
	...
	// Table name
	public $TableName = 'input4.php';

	// Page object name
	public $PageObjName = "input4";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'input4.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "input4", $url, "", "input4", TRUE);
		$this->Heading = $Language->TablePhrase("input4", "TblCaption"); 
	}
} // End class
?>