...
/**
 * Table class for t_distribusi
 */
class t_distribusi extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't_distribusi';
		$this->TableName = 't_distribusi';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t_distribusi`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('t_distribusi', 't_distribusi', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// source_id
		$this->source_id = new DbField('t_distribusi', 't_distribusi', 'x_source_id', 'source_id', '`source_id`', '`source_id`', 3, 11, -1, FALSE, '`source_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->source_id->Lookup = new Lookup('source_id', 't_source', FALSE, 'id', ["Nama","","",""], [], [], [], [], [], [], '', '');
		$this->source_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['source_id'] = &$this->source_id;

		// destination_id
		$this->destination_id = new DbField('t_distribusi', 't_distribusi', 'x_destination_id', 'destination_id', '`destination_id`', '`destination_id`', 3, 11, -1, FALSE, '`destination_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->destination_id->Lookup = new Lookup('destination_id', 't_destination', FALSE, 'id', ["Nama","","",""], [], [], [], [], [], [], '', '');
		$this->destination_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['destination_id'] = &$this->destination_id;

		// Jarak
		$this->Jarak = new DbField('t_distribusi', 't_distribusi', 'x_Jarak', 'Jarak', '`Jarak`', '`Jarak`', 4, 14, -1, FALSE, '`Jarak`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Rate_O
		$this->Rate_O = new DbField('t_distribusi', 't_distribusi', 'x_Rate_O', 'Rate_O', '`Rate_O`', '`Rate_O`', 4, 14, -1, FALSE, '`Rate_O`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Rate_O->Nullable = FALSE; // NOT NULL field
		$this->Rate_O->Required = TRUE; // Required field
		...
		// Rate_D
		$this->Rate_D = new DbField('t_distribusi', 't_distribusi', 'x_Rate_D', 'Rate_D', '`Rate_D`', '`Rate_D`', 4, 14, -1, FALSE, '`Rate_D`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Rate_D->Nullable = FALSE; // NOT NULL field
		$this->Rate_D->Required = TRUE; // Required field
		...
		// Demand
		$this->Demand = new DbField('t_distribusi', 't_distribusi', 'x_Demand', 'Demand', '`Demand`', '`Demand`', 4, 14, -1, FALSE, '`Demand`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`t_distribusi`";
	}
	...
	{
		global $Language;
		if ($pageName == "t_distribusiview.php")
			return $Language->phrase("View");
		elseif ($pageName == "t_distribusiedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t_distribusiadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("t_distribusiview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t_distribusiview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "t_distribusiadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t_distribusiadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t_distribusiedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t_distribusiadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t_distribusidelete.php", $this->getUrlParm());
	}
