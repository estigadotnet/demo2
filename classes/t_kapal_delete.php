 ...
 * Page class
 */
class t_kapal_delete extends t_kapal
{
	...
	// Page object name
	public $PageObjName = "t_kapal_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t_kapallist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("t_kapallist.php"); // Return to list
			}
		}
	}
