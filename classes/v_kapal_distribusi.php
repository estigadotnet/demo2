...
/**
 * Table class for v_kapal_distribusi
 */
class v_kapal_distribusi extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_kapal_distribusi';
		$this->TableName = 'v_kapal_distribusi';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_kapal_distribusi`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// kapal_id
		$this->kapal_id = new DbField('v_kapal_distribusi', 'v_kapal_distribusi', 'x_kapal_id', 'kapal_id', '`kapal_id`', '`kapal_id`', 3, 11, -1, FALSE, '`kapal_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// distribusi_id
		$this->distribusi_id = new DbField('v_kapal_distribusi', 'v_kapal_distribusi', 'x_distribusi_id', 'distribusi_id', '`distribusi_id`', '`distribusi_id`', 3, 11, -1, FALSE, '`distribusi_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_kapal_distribusi`";
	}
	...
	{
		return "`kapal_id` = @kapal_id@ AND `distribusi_id` = @distribusi_id@";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "v_kapal_distribusilist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "v_kapal_distribusiview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v_kapal_distribusiedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v_kapal_distribusiadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_kapal_distribusiview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_kapal_distribusiview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v_kapal_distribusiadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v_kapal_distribusiadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_kapal_distribusiedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_kapal_distribusiadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v_kapal_distribusidelete.php", $this->getUrlParm());
	}
