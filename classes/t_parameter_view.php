 ...
 * Page class
 */
class t_parameter_view extends t_parameter
{
	...
	// Page object name
	public $PageObjName = "t_parameter_view";
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if ($this->TotalRecords <= 0) { // No record found
						...
						$this->terminate("t_parameterlist.php"); // Return to list page
					...
					if (!$matchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->phrase("NoRecord")); // Set no record message
						$returnUrl = "t_parameterlist.php"; // No matching record, return to list
					} else {
						$this->loadRowValues($this->Recordset); // Load row values
					}
			}
		} else {
			$returnUrl = "t_parameterlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t_parameterlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
