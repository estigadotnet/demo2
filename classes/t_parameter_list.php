 ...
 * Page class
 */
class t_parameter_list extends t_parameter
{
	...
	// Table name
	public $TableName = 't_parameter';

	// Page object name
	public $PageObjName = "t_parameter_list";

	// Grid form hidden field names
	public $FormName = "ft_parameterlist";
	...
	public function __construct()
	{
		...
		// Table object (t_parameter)
		if (!isset($GLOBALS["t_parameter"]) || get_class($GLOBALS["t_parameter"]) == PROJECT_NAMESPACE . "t_parameter") {
			$GLOBALS["t_parameter"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["t_parameter"];
		}
		...
		$this->AddUrl = "t_parameteradd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "t_parameterdelete.php";
		$this->MultiUpdateUrl = "t_parameterupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 't_parameter');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft_parameterlistsrch";
	...
	{
		global $CurrentForm;
		if ($CurrentForm->hasValue("x_Parameter") && $CurrentForm->hasValue("o_Parameter") && $this->Parameter->CurrentValue != $this->Parameter->OldValue)
			return FALSE;
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ft_parameterlistsrch", $filters);
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft_parameterlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft_parameterlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		if (!$this->isGridAdd() && !$this->isGridEdit()) { // Not grid add/edit mode
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.ft_parameterlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	public function getRowHash(&$rs)
	{
		if (!$rs)
			return "";
		$hash = "";
		$hash .= GetFieldHash($rs->fields('Parameter')); // Parameter
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ft_parameterlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
		$item->Visible = TRUE;
