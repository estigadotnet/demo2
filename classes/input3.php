...
class input3
{
	...
	// Table name
	public $TableName = 'input3.php';

	// Page object name
	public $PageObjName = "input3";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'input3.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "input3", $url, "", "input3", TRUE);
		$this->Heading = $Language->TablePhrase("input3", "TblCaption"); 
	}
} // End class
?>