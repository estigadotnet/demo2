...
class input
{
	...
	// Table name
	public $TableName = 'input.php';

	// Page object name
	public $PageObjName = "input";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'input.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "input", $url, "", "input", TRUE);
		$this->Heading = $Language->TablePhrase("input", "TblCaption"); 
	}
} // End class
?>